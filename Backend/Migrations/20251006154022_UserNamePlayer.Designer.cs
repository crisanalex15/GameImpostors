...
namespace Backend.Migrations
{
    ...
    [Migration("20251006154022_UserNamePlayer")]
    partial class UserNamePlayer
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Backend.Models.Answer", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2025, 10, 6, 15, 40, 21, 956, DateTimeKind.Utc).AddTicks(7820));
            ...
            modelBuilder.Entity("Backend.Models.GameObject", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2025, 10, 6, 15, 40, 21, 954, DateTimeKind.Utc).AddTicks(9906));
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2025, 10, 6, 15, 40, 21, 955, DateTimeKind.Utc).AddTicks(35));
            ...
            modelBuilder.Entity("Backend.Models.Player", b =>
                {
                    ...
                    b.Property<DateTime>("JoinedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2025, 10, 6, 15, 40, 21, 955, DateTimeKind.Utc).AddTicks(2471));
            ...
            modelBuilder.Entity("Backend.Models.Questions.Question", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2025, 10, 6, 15, 40, 21, 956, DateTimeKind.Utc).AddTicks(9177));
            ...
            modelBuilder.Entity("Backend.Models.Questions.WordHidden", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2025, 10, 6, 15, 40, 21, 957, DateTimeKind.Utc).AddTicks(323));
            ...
            modelBuilder.Entity("Backend.Models.Round", b =>
                {
                    ...
                    b.Property<DateTime>("StartedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2025, 10, 6, 15, 40, 21, 956, DateTimeKind.Utc).AddTicks(6526));
            ...
            modelBuilder.Entity("Backend.Models.Vote", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2025, 10, 6, 15, 40, 21, 956, DateTimeKind.Utc).AddTicks(8256));
