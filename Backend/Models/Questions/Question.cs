...
namespace Backend.Models.Questions
{
    public class Question
    {
        ...
        [Required]
        [StringLength(500, MinimumLength = 10)]
        public string FakeQuestionText { get; set; } = string.Empty;
        ...
        public int ReviewCount { get; set; } = 0; // How many players rated this question
        ...
        // Helper methods
        public void UpdateQuestion(string questionText, string fakeQuestionText, string category)
        {
