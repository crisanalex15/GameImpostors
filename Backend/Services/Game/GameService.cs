...
namespace Backend.Services.Game
{
    public class GameService : IGameService
    {
        ...
        public async Task<(bool Success, GameObject? Game, string Message)> CreateGameAsync(Guid hostId, GameType gameType, int maxPlayers = 6)
        {
            try
            {
        ...
        public async Task<(bool Success, GameObject? Game, string Message)> JoinGameAsync(string lobbyCode, Guid userId)
        {
            try
            {
